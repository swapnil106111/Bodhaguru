...
SOURCE_ID = "BodhaGuru Balbharati English "                             # an alphanumeric channel ID
CHANNEL_TITLE = "BodhaGuru Balbharati English "       # a humand-readbale title
CHANNEL_LANGUAGE = "en"                            # language code of channel
count = 1
path_of_content= "/home/kolibri/Documents/Final_Bodhaguru/English/"
...
sample_tree = {}
sample_tree['title'] = "English"
sample_tree['id'] = "English"
            ...
            for subfolder2 in os.listdir(path2):
                ...
                for subfolder3 in os.listdir(path3):
                    if subfolder3.endswith('.zip'):
                        ...
                        video_dict['title'] = subfolder3.replace('.mp4','')
                        video_dict['license'] = "All Rights Reserved"  
                        video_dict['copyright_holder'] = "BodhaGuru"
                        video_dict['files']=[{"path": path3+subfolder3}]
                        subfolder_dict2['children'].append(video_dict)    
