...
SOURCE_ID = "BodhaGuru CBSE English"                             # an alphanumeric channel ID
CHANNEL_TITLE = "BodhaGuru CBSE English"       # a humand-readbale title
CHANNEL_LANGUAGE = "en"                            # language code of channel
count = 1
path_of_content= "/home/kolibri/Documents/Bodhaguru/CBSE_Bodhaguru/content/English/"
...
def video_node(video_path, subfolder_name):
    ...
    video_dict['title'] = subfolder_name.replace('.mp4','')
